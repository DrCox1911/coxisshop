--[[
#########################################################################################################
#	@mod:		LuaNet - NetWorking wrapper for mods                                                    #
#	@author: 	Kees Bekkema AKA TurboTuTone                                                            #
#	@notes:		Many thanks to EasyP! for adding functionality to make some of this stuff work.			#
#	@notes:		For usage instructions check forum link below                                  			#
#	@link: 		http://theindiestone.com/forums/index.php         										#
#########################################################################################################
--]]
...
function LuaNet:getInstance()
	...
	-- ***********************************************************************************************
	-- Init
	-- Can only be called internally, sets listners and triggers Init event
	-- ***********************************************************************************************	
	function self.Init()
